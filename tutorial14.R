...
tagList(
  ...
  ,tags$script(type = "text/babel"
    ...
    // tutorial14.js
    ReactDOM.render(
      <CommentBox url="http://gist.githubusercontent.com/timelyportfolio/54314c31733f4b73f2a0/raw/0668753905075f5ea3ef8a2d5198702cf0c473d5/comments.json" pollInterval={2000} />,
